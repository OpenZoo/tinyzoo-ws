...
static uint8_t __far* oop_prog_loc;
static uint8_t __far* oop_code_loc;
static uint8_t __far* oop_last_code_loc;
...
bool oop_find_label_in_stat(uint8_t stat_id, uint8_t label_id, bool zapped, uint8_t set_zap) {
	...
	uint8_t __far* label_loc = prog_loc + label_offset;
